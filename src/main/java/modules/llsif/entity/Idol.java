...
public enum Idol {
    HONOKA  	(
    	        ...
    	        "Nitta Emi", 
    	        "Emitsun", 
    	        "A 16-year-old, second-year high school student and founder of µs. She is always smiling, and her redeeming feature is her energy. She acts on impulse and always runs head-first into things once shes made up her mind. Any and all problems are overcome with her inherent optimism, making her the engine and driving force behind µs.",
    ...
    KOTORI  	(
	        ...
	        "Uchida Aya", 
	        "Ucchi", 
	        "A 16-year-old, second-year high school student and  Honokas closest friend. Theyve been together since kindergarten. In contrast to Honoka, she has a kind and gentle personality, focuses on her studies, and is a model student. Although shes so gentle, shes also confident and reliable.",
    ...
    HANAYO	(
	        ...
	        "Kubo Yurika", 
	        "Shikaco", 
	        "A 15-year-old, first-year high school student. Shes a quiet girl who doesnt stand out much in class and loves white rice. She lacks self-esteem and is quick to give up on almost anything she does. Admiring µs, she joins the group along with Rin, her closest friend and the person shes always together with, and Maki.",
    ...
    NICO	(
	        ...
	        "Tokui Sora", 
	        "Soramaru", 
	        "A 17-year-old, third-year high school student and a true idol otaku. As an upperclassman whos trying her hardest around the clock to become an idol, she frequently comes into contact with Honoka and the others while acting like a big shot. However, it turns out that she often makes mistakes and is unexpectedly clumsy. Her favorite saying is Nico Nico Nii.",
    ...
    CHIKA	(
	        ...
	        "Inami Anju", 
	        "Anchan", 
	        "The second-year student at Uranohoshi Girls High School who launched Aqours. The youngest of three sisters, she comes from a family that runs a traditional Japanese inn and is proud of their open-air, ocean-view bath. Shes sociable and hates giving up. Her positive, pushy attitude gradually affects everyone around her.",
    ...
    RIKO	(
	        ...
	        "Rikako Aida", 
	        "Rikyako", 
	        "A second-year from Akihabara who transferred into Chikas class. An average girl with a reserved personality who would rather stay indoors than go out. While she seems mature and collected, she is actually quite careless, frequently jumping to conclusions and making mistakes.",
    ...
    DIA		(
	        ...
	        "Komiya Arisa", 
	        "Arisha", 
	        "A third-year student and president of the student council. Hails from an old fishing family whose name is well-known around the area. Prideful and a perfectionist, she cant sit still when things are done sloppily or incorrectly.",
    ...
    YOU		(
	        ...
	        "Saitou Shuka", 
	        "Shukashuu", 
	        "A second-year student and Chikas classmate. Good enough at the high dive to qualify for the national team. A sporty type whose hobby is weight training, she tends to take action without thinking matters over first. Her father captains a ferry, and her dream is to have his job someday.",
    ...
    YOSHIKO	(
	        ...
	        "Kobayashi Aika", 
	        "Aikyan", 
	        "A first-year student who likes the little devil look and proclaims to be Fallen Angel Jeanne. Born in the urban side of Numazu city, shes bright, fearless, smart, and thoughtful. However, she has extremely bad luck, running into all kinds of unforeseen trouble wherever she goes.",
    ...
    RUBY	(
	        ...
	        "Furihata Ai", 
	        "Aiai", 
	        "A first-year student whos almost always with her good friend Hanamaru. She is cowardly and tends to cry a lot, but she still has a tough interior, forged by her role as the daughter of a rich, well-known family. She has always looked up to idols and needlework is the only thing shes really great at.",
